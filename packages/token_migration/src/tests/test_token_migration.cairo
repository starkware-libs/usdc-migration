...
fn test_set_legacy_buffer() {
    ...
    assert_expected_event_emitted(
        ...
        expected_event: LegacyBalanceBufferUpdated { old_buffer: LEGACY_BUFFER, new_buffer },
        expected_event_selector: @selector!("LegacyBalanceBufferUpdated"),
        expected_event_name: "LegacyBalanceBufferUpdated",
    );
}
...
fn test_set_batch_size() {
    ...
    assert_expected_event_emitted(
        spied_event: events[0],
        expected_event: BatchSizeUpdated { old_batch_size: LARGE_BATCH_SIZE, new_batch_size },
        expected_event_selector: @selector!("BatchSizeUpdated"),
        expected_event_name: "BatchSizeUpdated",
    );
}
