...
pub mod TokenMigration {
    ...
    impl TokenMigrationInternalImpl of TokenMigrationInternalTrait {
        fn _swap(
            ...
            let to_token_balance_before = to_token.balance_of(account: contract_address);
            let from_token_balance_before = from_token.balance_of(account: contract_address);
            assert(
            ...
            let from_token_balance_after = from_token.balance_of(account: contract_address);
            let to_token_balance_after = to_token.balance_of(account: contract_address);
            assert(
