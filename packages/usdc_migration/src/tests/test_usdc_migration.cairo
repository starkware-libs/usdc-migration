...
use usdc_migration::tests::test_utils::{
    approve_and_swap, deploy_token_bridge_mock, deploy_tokens, deploy_usdc_migration,
    generic_test_fixture, load_contract_address, load_u256, new_user, supply_contract,
};
...
fn test_set_legacy_threshold_trigger_send_to_l1() {
    ...
    let new_batch_size = load_u256(usdc_migration_contract, selector!("batch_size"));
    assert_eq!(
...
fn test_token_bridge_mock() {
    ...
    ITokenBridgeMockDispatcher { contract_address: starkgate_address }
        .set_l2_token_address(l2_token_address: legacy_token.contract_address());
    ...
    ITokenBridgeDispatcher { contract_address: starkgate_address }
