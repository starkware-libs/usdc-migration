...
fn test_constructor() {
    ...
    assert_eq!(100000, load_u256(usdc_migration_contract, selector!("curr_transfer_unit")));
...
#[test]
#[should_panic(expected: "Invalid legacy threshold")]
...
fn test_set_legacy_threshold() {
    ...
    let curr_transfer_unit = load_u256(usdc_migration_contract, selector!("curr_transfer_unit"));
    ...
    usdc_migration_cfg_dispatcher.set_legacy_threshold(threshold: new_threshold);
    assert_eq!(new_threshold, load_u256(usdc_migration_contract, selector!("legacy_threshold")));
    assert_eq!(10000, load_u256(usdc_migration_contract, selector!("curr_transfer_unit")));
...
fn test_set_legacy_threshold_assertions() {
    ...
    assert_panic_with_error(:result, expected_error: Error::INVALID_LEGACY_THRESHOLD.describe());
}
